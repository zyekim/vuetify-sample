<template>
  <v-container>
    ...
    <v-card class="mt-5">
      <v-card-title>
        $vuetify.breakpoint.mobile: {{ $vuetify.breakpoint.mobile }} in width {{ $vuetify.breakpoint.mobileBreakpoint }} px
      </v-card-title>
      <v-container class="grey lighten-3">
        <v-dialog
          v-model="dialog"
    ...
    <v-card class="mt-5">
      ...
      <v-container class="grey lighten-3">
        ...
        >
          ...
          $vuetify.breakpoint.smAndDown: {{ $vuetify.breakpoint.smAndDown }} <!-- sm 벗어나면 false--> <br>
